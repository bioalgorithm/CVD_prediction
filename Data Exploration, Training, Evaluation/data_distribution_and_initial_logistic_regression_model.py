...
#let's look if data is balanced by looking at target variable (Cardio)
print(data['Cardio'].value_counts())

#there are 31181 values of 0 and 30922 of 1. Therefore our data is balanced.
#let's plot a figure of this
